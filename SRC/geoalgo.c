...
// 		while(1)
// 		{
// 			if (ordonnePolair(plgn, son, father))
// 			{
// 				son = father;
// 				father = son/2;
// 			}
...
// void downHeap(Vertex plgn[], int n)
// {
// 	int son, father, LOOP;
// 	while(n > 1)
// 	{
// 		switchCells(plgn, 1, n);
// 		father = 1;
// 		son = father * 2;
// 		LOOP = 1;
// 		while(LOOP)
// 		{
// 			int nbSon = getNumberOfSon(son, n-1);
// 			switch (nbSon)
// 			{
// 				case 2: son = getMaxOfSons(plgn, son);
// 					ordonnePolair(plgn, son, father);
// 					break;
// 				case 1: ordonnePolair(plgn, son, father);
// 					break;
// 				case 0: LOOP = 0;
// 					break;
// 				default: printf("Error in function downHeap\n");
// 					break;
// 			}
